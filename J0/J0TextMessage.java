...
serves as the entry point of the program. It is the method that is executed when you 
run the program. The method takes an array of strings called "args" as a parameter. 
These arguments can be passed to the program when running it from the command line, 
but in this case, they are not used.
